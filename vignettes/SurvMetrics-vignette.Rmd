...
```{r fig.align='center', message=FALSE, warning=FALSE, results='hide',eval=FALSE,purl=FALSE}
set.seed(123)
#Initialization
metrics_cox = 0
metrics_rsf = 0
...
simres=system.file("extdata", "SimRes.RData", package = "SurvMetrics")
load(simres)
```
